...
//#region node_modules/opus-recorder/dist/recorder.min.js
var require_recorder_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		return function(e) {
			...
			(function(t) {
				...
				var n = t.AudioContext || t.webkitAudioContext, i = function e() {
				...
				i.isRecordingSupported = function() {
					...
					var e = this;
					return this.config.sourceNode.context ? (this.sourceNode = this.config.sourceNode, Promise.resolve()) : t.navigator.mediaDevices.getUserMedia({ audio: this.config.mediaTrackConstraints }).then((function(t) {
						e.stream = t, e.sourceNode = e.audioContext.createMediaStreamSource(t);
					}));
				}, i.prototype.initWorker = function() {
					var e = this, t = (this.config.streamPages ? this.streamPage : this.storePage).bind(this);
						...
						e.encoder.addEventListener("message", (function o(i) {
							...
							switch (r.message) {
								...
								case "page":
									...
									break;
								case "done": e.encoder.removeEventListener("message", o), e.finish();
							}
						})), e.encoder.start && e.encoder.start();
						var i = e.config, r = (i.sourceNode, o(i, ["sourceNode"]));
					...
					if ("recording" === this.state) return this.state = "paused", this.recordingGainNode.disconnect(), e && this.config.streamPages ? new Promise((function(e) {
						...
						})), t.encoder.start && t.encoder.start(), t.encoder.postMessage({ command: "flush" });
